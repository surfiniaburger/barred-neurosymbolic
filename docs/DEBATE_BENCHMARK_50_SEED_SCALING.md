...
| **Attempt Logic Errors** | 0 (0.0%) | 0.00 ± 0.00 (0.0%) | **5 / 73 (6.8%)** | **0 / 64 (0.0%)** | **5 / 67 (7.5%)** | **3 / 64 (4.7%)** | **3 / 70 (4.3%)** | **7 / 71 (9.9%)** | **3.60 ± 2.68 (5.4% ± 3.6%)** | **[0.27, 6.93] errors** |
| **Total Attempts** | 20 | 13.60 ± 1.14 | **73 (1.46/seed)** | **64 (1.28/seed)** | **67 (1.34/seed)** | **64 (1.28/seed)** | **70 (1.40/seed)** | **71 (1.42/seed)** | **67.20 ± 3.27 (1.34/seed)** | **[63.1, 71.3] attempts** |
...
- **Zero accepted logic errors** ($0 / 196$ descriptive accepted rows across 5 runs, $0.0000 \pm 0.0000$ run-level rate). A total of 18 attempt-level logic errors occurred across 336 attempts (5.4%), all of which were successfully intercepted and quarantined by the Predictive Verifier before reaching the accepted corpus.
